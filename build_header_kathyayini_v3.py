...
svg_content = '''<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 280" width="800" height="280">
  ...
  <!-- LEFT CARD: LIVE CODE GREETING (WITH INTERNSHIP OBJECTIVE) -->
  <g transform="translate(24, 38)">
    ...
    <g transform="translate(14, 34)" font-family="'Fira Code', monospace" font-size="9">
      <!-- Line 1: Comment -->
      ...
      <!-- Line 4: Return statement with Internship Objective -->
      <text x="12" y="82">
        <tspan fill="#F43F5E">return</tspan> <tspan fill="#A78BFA" font-weight="600">"Open to AI/ML, Data Science"</tspan>
      </text>
      <text x="56" y="98">
        <tspan fill="#A78BFA" font-weight="600">&amp; Software Internships"</tspan>
      </text>

      <!-- Line 5: Execution Terminal Call -->
      <text x="0" y="120" fill="#E2E8F0">
        <tspan fill="#34D399">&gt;&gt;&gt;</tspan> <tspan fill="#F8FAFC">print(welcome())</tspan>
      </text>

      <!-- Line 6: Printed Output with Glowing Cyan Cursor -->
      <rect x="0" y="128" width="227" height="24" rx="4" fill="#161B22" />
      <text x="8" y="144" fill="#34D399" font-weight="800">Hi, this is Kathyayini here!</text>
      <rect x="202" y="135" width="6" height="11" fill="#00F2FE">
  ...
  <!-- RIGHT CARD: SYSTEM PROFILE (TECH STACK REMOVED, OPPORTUNITY STATUS HIGHLIGHTED) -->
  <g transform="translate(295, 38)">
    ...
    <g font-family="'Fira Code', monospace" font-size="11" font-weight="500" fill="#CBD5E1">
      ...
      <!-- OPPORTUNITY STATUS (REPLACING TECH STACK) -->
      <text x="18" y="146"><tspan fill="#34D399" font-weight="800">OPPORTUNITY.STATUS</tspan></text>
      <text x="18" y="162"> <tspan fill="#94A3B8">Target:</tspan>      <tspan fill="#F8FAFC">AI/ML, Data Science &amp; Software Internships</tspan></text>
      <text x="18" y="178"> <tspan fill="#94A3B8">Status:</tspan>      <tspan fill="#38BDF8" font-weight="700">Actively Seeking Opportunities</tspan></text>
    </g>
...
print("XML Validation for header-kathyayini.svg (v3): 100% PASSED!")
