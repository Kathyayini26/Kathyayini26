...
svg_content = '''<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 280" width="800" height="280">
  ...
  <!-- LEFT CARD: LIVE CODE GREETING (ZERO REPETITION) -->
  <g transform="translate(24, 38)">
    ...
    <g transform="translate(14, 34)" font-family="'Fira Code', monospace" font-size="9.5">
      ...
      <text x="12" y="90">
        <tspan fill="#F43F5E">return</tspan> <tspan fill="#A78BFA">"Ready to build software."</tspan>
      </text>

      <!-- Line 5: Execution Terminal Call -->
      <text x="0" y="118" fill="#E2E8F0">
  ...
  <!-- RIGHT CARD: COMPLETE SYSTEM PROFILE (NAME & DEPARTMENT SHOWN EXACTLY ONCE) -->
  <g transform="translate(295, 38)">
    ...
    <g font-family="'Fira Code', monospace" font-size="11" font-weight="500" fill="#CBD5E1">
      ...
      <!-- Tech Stack & Focus Section -->
      <text x="18" y="146"><tspan fill="#34D399" font-weight="800">TECH.STACK &amp; FOCUS</tspan></text>
      <text x="18" y="162"> <tspan fill="#94A3B8">Core:</tspan>       <tspan fill="#F8FAFC">Python, C, SQL, MySQL, Flask, React</tspan></text>
      <text x="18" y="178"> <tspan fill="#94A3B8">Focus:</tspan>      <tspan fill="#F8FAFC">Machine Learning &amp; Database Architecture</tspan></text>
    </g>

    <!-- Bottom Action Pills Row (No Repetition) -->
