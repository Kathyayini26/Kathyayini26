...
svg_content = '''<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 280" width="800" height="280">
  <defs>
    ...
    <linearGradient id="main-bg-grad-v20" x1="0%" y1="0%" x2="100%" y2="100%">
    ...
    <linearGradient id="main-border-grad-v20" x1="0%" y1="0%" x2="100%" y2="0%">
    ...
    <!-- Glow Filter -->
    <filter id="main-glow-v20" x="-20%" y="-20%" width="140%" height="140%">
  ...
  <rect width="800" height="280" rx="16" fill="url(#main-bg-grad-v20)" stroke="url(#main-border-grad-v20)" stroke-width="1.8" />

  <!-- Top Accent Shimmer Line -->
  <rect x="0" y="0" width="800" height="5" rx="2.5" fill="url(#main-border-grad-v20)" filter="url(#main-glow-v20)" />
  ...
  <g transform="translate(24, 38)">
    <rect width="255" height="224" rx="12" fill="#0D1117" stroke="#38BDF8" stroke-width="1.2" filter="url(#main-glow-v20)" />
  ...
  <g transform="translate(295, 38)">
    ...
    <g transform="translate(18, 150)">
      ...
      <path d="M 12 15 L 60 15 L 75 6 L 90 24 L 105 10 L 120 18 L 135 15 L 200 15" fill="none" stroke="#00F2FE" stroke-width="1.6" filter="url(#main-glow-v20)">
...
print("XML Validation for header-v20.svg: 100% PASSED!")

with open(r'C:\Users\Kathyayini\.gemini\antigravity\scratch\Kathyayini-12\assets\header-v20.svg', 'w', encoding='utf-8') as f:
    f.write(svg_content)

print("assets/header-v20.svg written successfully!")
